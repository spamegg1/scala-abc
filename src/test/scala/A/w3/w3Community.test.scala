...
class Week2CommunitySuite extends munit.FunSuite:
  test("01. composeOpt"):
    val firstArgs: List[Int => Option[Int]] = List(x =>
      Some(x * x)
      // add more functions here!
    )
    val secondArgs: List[Int => Option[Int]] = List(y =>
      Some(y * 2)
      // add more functions here!
    )
  ...
  test("02. doUntil"):
    val firstArgs: List[Int => Int] = List(x =>
      x / 2
      // add more functions here!
    )
    val secondArgs: List[Int => Boolean] = List(y =>
      y % 2 != 1
      // add more functions here!
    )
  ...
  test("05. map2"):
    val firstArgs: List[Int => Boolean] = List(x =>
      x % 2 == 0
      // add more functions here!
    )
  ...
  test("06. appAll"):
    val firstArgs: List[Int => List[Double]] = List(x =>
      List(x / 2, x / 4)
      // add more functions here!
    )
    val secondArgs: List[String => List[Int]] = List(x =>
      List(x.length)
      // add more functions here!
    )
