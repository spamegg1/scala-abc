...
// The problems below also make use of the following
...
// produces true if path passes through room b to get to room c, "never"
// if room c is never reached, false otherwise
