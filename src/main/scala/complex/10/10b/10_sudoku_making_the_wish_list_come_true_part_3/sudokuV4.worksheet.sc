...
// a Natural[1, 9] such that no unit contains a duplicate number.
...
def rowColToPos(row: Int, col: Int): Pos = row * 9 + col
...
// finds first empty square, fills with Natural[1, 9], keeps only valid boards
